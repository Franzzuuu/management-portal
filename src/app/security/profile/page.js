    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Navigate to security dashboard after 1.5 seconds
                setTimeout(() => {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                {/* Navigation */}
                <div className="mb-6">
                    <BackButton text="Back to Dashboard" fallbackPath="/security" />
                </div>
                ...
                <div className="mb-8 p-6 rounded-xl shadow-lg" style={{ background: 'linear-gradient(135deg, #355E3B 0%, #2d4f32 100%)' }}>
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            <h2 className="text-2xl font-bold text-white">Security Profile Management</h2>
                ...
                <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                    ...
                    <form onSubmit={handleSave} className="p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            {/* 4-Digit PIN (Read-only with toggle visibility) */}
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">
                                    Your 4-Digit PIN
                                    <span className="text-xs text-gray-500 ml-2">(For handheld device)</span>
                                </label>
                                <div className="relative">
                                    <input
                                        type={showPin ? "text" : "password"}
                                        value={profile.pin || '●●●●'}
                                        className="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-50 text-gray-900 font-mono text-lg tracking-widest"
                                        disabled
                                        readOnly
                                    />
                                    <button
                                ...
                                {profile.pin && (
                                    <p className="text-xs text-gray-500 mt-1">
                                        ℹ️ Use this PIN when logging violations on the handheld device
                                    </p>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="p-6">
                        ...
                        <div className="mt-6 p-4 bg-orange-50 border border-orange-200 rounded-lg">
                            <div className="flex items-center">
                                ...
                                <div>
                                    <p className="text-sm text-orange-700 font-medium">Security Personnel Access</p>
                                    <p className="text-xs text-orange-600">You have security privileges for violation management and monitoring.</p>
                                </div>
                            </div>
                        </div>
                    </div>
