                    ...
                    <div className="bg-white/95 backdrop-blur-sm py-6 px-5 shadow-2xl rounded-xl border border-white/20">
                        ...
                        <div className="mt-4">
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-lg transform hover:-translate-y-0.5 hover:cursor-pointer"
                                style={{
